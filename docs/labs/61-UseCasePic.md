...
If you want to learn more about UML, you can visit the official UML website here: https://www.uml.org/.
...
For a more concrete example of how UML is used in software development, consider the following use case. 
...
you and your team would create a use case diagram using UML to outline all interactions 
...
like payment gateways or databases. By using UML, you get a high level view and ensure the app meets user needs.
